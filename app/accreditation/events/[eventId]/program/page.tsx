  ...
  if (!isAccreditationPhase2EventType(event.eventType)) {
    return (
      <WorkspaceNotice
        ...
        description="El programa y las sesiones solo están disponibles para eventos de tipo Festival, Concierto, Corporativo, Conferencia, Seminario, Teatro o Taller."
      />
    );
  }
  ...
  return (
    <main className="mx-auto w-full max-w-[1280px] space-y-5 px-4 py-6 sm:px-6 lg:px-0">
      <Topbar
        ...
        description="Agenda operativa para Festival, Concierto, Corporativo, Conferencia, Seminario, Teatro y Taller sin usar acceso, check-in ni RSVP."
        secondaryAction={{
